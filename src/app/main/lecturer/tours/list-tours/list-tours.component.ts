...
export class ListToursComponent implements OnInit {
  ...
  lstours = [
    { id: 1, tenongty: 'cty 01', machuyen: 'chuyen 1', trangThai: true },
    { id: 2, tenongty: 'cty 02', machuyen: 'chuyen 2', trangThai: false },
    { id: 3, tenongty: 'cty 03', machuyen: 'chuyen 3', trangThai: true },
    { id: 4, tenongty: 'cty 04', machuyen: 'chuyen 4', trangThai: false },
  ];

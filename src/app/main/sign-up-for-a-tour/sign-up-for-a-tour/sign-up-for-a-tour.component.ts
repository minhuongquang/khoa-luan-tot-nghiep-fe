...
import { SignUpForATourService } from 'src/app/core/services/sign-up-for-a-tour/sign-up-for-a-tour.service';
import { SystemConstant } from 'src/app/core/constants/system.constant';
import { ModalData } from 'src/app/core/models/common/modal-data.model';
import { LanguageConstant } from 'src/app/core/constants/language.constant';
import { SignUpForATour } from 'src/app/core/models/sign-up-for-a-tour/sign-up-for-a-tour.model';

@Component({
  selector: 'app-sign-up-for-a-tour',
  templateUrl: './sign-up-for-a-tour.component.html',
  styleUrls: ['./sign-up-for-a-tour.component.scss']
})
export class SignUpForATourComponent implements OnInit {
  @Input() modalData: ModalData<SignUpForATour>;
  ...
  constructor(
    ...
    private signUpForATourSvc: SignUpForATourService,
  ...
  onSubmit(): void {
    if (this.form.valid) {
      if (this.modalData.action === SystemConstant.ACTION.EDIT) {
        ...
        this.spinner.show();
        this.signUpForATourSvc.create(this.form.value).subscribe(
          () => {
            this.closeModal.emit(true);
            this.alert.success(
